...
require (
	...
	github.com/philips-software/terraform-provider-hsdp v1.1.1
...
require (
	...
	github.com/loafoe/caddy-token v0.77.0 // indirect
	...
	github.com/philips-software/go-dip-api v0.96.0 // indirect
