...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewNoForkAsyncConnector(mgr.GetClient(), o.OperationTrackerStore, o.SetupFn, o.Provider.Resources["hsdp_iam_client"],
				...
				tjcontroller.WithNoForkAsyncMetricRecorder(metrics.NewMetricRecorder(v1alpha1.Client_GroupVersionKind, mgr, o.PollInterval)),
