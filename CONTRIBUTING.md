...
If you have questions about how to use the HSDP crossplane provider, please direct these to the #crossplane channel on HSDP Slack or open a [discussion](https://github.com/philips-software/provider-hsdp/discussions).
...
In Github, send a pull request to original main branch: f.e. `provider-hsdp:main`.
...
For more info, please reach out to the team on [Slack group / hsdp-utilities][slack] in the #hsdp-utilities channel.

[contribute]: CONTRIBUTING.md
[github]: https://github.com/philips-software/provider-hsdp/issues 
